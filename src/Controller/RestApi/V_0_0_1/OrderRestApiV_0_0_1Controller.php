...
class OrderRestApiV_0_0_1Controller extends AbstractController
{
    ...
    public function createOrder(Request $request): Response
    {
        ...
        $newOrder->setDeliveryDatetime($deliveryDatetime);
        ...
        $newOrder->setReturnedDatetime($returnedDatetime);
    ...
    public function updateOrderById(int $id, Request $request): Response
    {
        ...
        $updateOrder->setDeliveryDatetime($deliveryDatetime);
        ...
        $updateOrder->setReturnedDatetime($returnedDatetime);
